...
/**
 * Unit test for {@link DateOperations}
 */
public class DateOperationsTest {
    private final DateOperations ops = new DateOperations();

    /**
     * Unit test {@link DateOperations#duration(ZonedDateTime, ZonedDateTime, String)}
     */
    @Test
