 ...
 * As EEL expressions are loosely typed, the result could be a text string, a number or a logic (boolean) value.
 * The client is free the most appropriate type and the Result will attempt to convert it as required.
 */
